...
contract SquadV3Factory is ISquadV3Factory {
    ...
    bytes32 public constant INIT_CODE_PAIR_HASH = keccak256(abi.encodePacked(type(SquadV3Pool).creationCode));
    ...
    function collectProtocol(
        ...
        return ISquadV3Pool(pool).collectProtocol(recipient, amount0Requested, amount1Requested);
    }
