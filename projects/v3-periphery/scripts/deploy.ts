...
async function main() {
  ...
  const squadV3PoolDeployer_address = '0xB0edb49557c583290368e04FffaBb293FC224Ae1';
  const squadV3Factory_address = '0xC200B8E8eE9A4BFd22a2F31a3a64e581A3c9e793';

  const SwapRouter = new ContractFactory(artifacts.SwapRouter.abi, artifacts.SwapRouter.bytecode, owner);
  const swapRouter = await SwapRouter.deploy(squadV3PoolDeployer_address, squadV3Factory_address, WBNB);
